<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#eb5757">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url(); ?>">
        ...
        <div class="sidebar-brand-text mx-3">Bioskopin</div>
      </a>
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              ...
              <div class="input-group-append">
                <button class="btn btn-primary" style="background-color:#eb5757; border-color: #eb5757;" type="button">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <div class="navbar">
              <ul class="nav navbar-nav navbar-right">
                <li >
                  <?php
                  $keranjang = '<i class="fa-solid fa-ticket-simple" style="color:#eb5757"></i> ' . $this->cart->total_items() . ' tickets'
                  ?>
