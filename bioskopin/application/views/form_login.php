              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Login Bioskopin</h1>
                  </div>
                  ...
                  <form method="post" action="<?php echo base_url('auth/login') ?>" class="user">
                    ...
                    <button type="submit" class="btn btn-primary btn-user btn-block" style="background-color:#eb5757; border-color: #eb5757">Login</button>
                  </form>
                  <hr>
                  <div class="text-center">
